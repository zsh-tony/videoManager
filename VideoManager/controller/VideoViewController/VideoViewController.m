...
- (void)viewDidLoad {
    ...
    request = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://www.fhzpt.com:8082/EnterClinic/movieManage?account=13080908250"]];
    [webView loadRequest:request];
    titleBtn = [[TitleButton alloc]initWithFrame:CGRectMake(0, 0, 80, 44) WithTitle:@"视频"];
...
//    UIBarButtonItem *doneItem = [[UIBarButtonItem alloc]initWithBarButtonSystemItem:UIBarButtonSystemItemStop target:self action:@selector(done)];
